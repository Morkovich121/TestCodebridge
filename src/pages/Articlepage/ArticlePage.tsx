    ...
    return (
        <>
            <div className='containerArticle'>
                <img src={newsImage} alt="" className='articleImage' />
                <Card className="articleCard" sx={{
                    ...
                    <CardContent className='articleCard__content' sx={{ padding: "35px 75px" }}>
                        <Typography sx={{ fontSize: "24px", fontFamily: "Montserrat" }}>The 2020 World's Most Valuable Brands</Typography>
                        <Typography sx={{ fontSize: "18px", fontFamily: "Montserrat" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Interdum ornare convallis non etiam tincidunt tincidunt. Non dolor vel purus id. Blandit habitasse volutpat id dolor pretium, sem iaculis. Faucibus commodo mauris enim, turpis blandit.
                            ...
                            Porttitor facilisi viverra mi lacus lacinia accumsan. Pellentesque gravida ligula bibendum aliquet nulla massa elit. Ac faucibus donec sit morbi pharetra urna. Vel facilisis amet placerat ultrices lobortis proin nulla. </Typography>
                    </CardContent>
                </Card>
            </div>
